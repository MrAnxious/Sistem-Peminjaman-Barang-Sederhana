...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $gambar = uploadGambar(); // Fungsi untuk upload gambar

    if ($gambar) {
        $query = "INSERT INTO barang (nama_barang, jumlah, keterangan, gambar) VALUES ('$nama_barang', $jumlah, '$keterangan', '$gambar')";
        $koneksi->query($query);
